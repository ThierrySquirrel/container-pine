...
import io.github.thierrysquirrel.pine.hummingbird.service.core.factory.execution.SynchronousProducersFactoryExecution;
...
public class HeartbeatHandler {
    ...
    public void ping(SocketChannelFacade<PineRequestContext> socketChannelFacade, PineRequestContext pineRequestContext, String clientServiceName, String clientServiceUrl) throws Throwable {
        ...
        socketChannelFacade.sendMessage(pangPineRequestContext);
        String clusterServiceUrl = pineLoading.getClusterServiceUrl();
        ...
        if (!Objects.isNull(clusterServiceUrl) && !clusterServiceUrl.isEmpty()) {
            SynchronousProducersFactoryExecution.execution(clusterServiceUrl, pineLoading.getServiceUrl(), synchronousProducers);
        }
    }
