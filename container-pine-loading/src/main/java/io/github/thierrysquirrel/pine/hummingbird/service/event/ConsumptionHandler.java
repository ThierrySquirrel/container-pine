...
public class ConsumptionHandler {
    ...
    public void byProducersNameGetUrls(SocketChannelFacade<PineRequestContext> socketChannelFacade, PineRequestContext pineRequestContext, String producersName) throws Throwable {
        ...
        socketChannelFacade.sendMessage(byProducersNameGetUrls);
    }
}
