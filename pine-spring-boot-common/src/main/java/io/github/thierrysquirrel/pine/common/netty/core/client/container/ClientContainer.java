...
package io.github.thierrysquirrel.pine.common.netty.core.client.container;
...
public class ClientContainer {
    private static final Map<String, ThreadLocal<EventLoopGroup>> EVENT_LOOP_GROUP_MAP = new ConcurrentHashMap<>();
