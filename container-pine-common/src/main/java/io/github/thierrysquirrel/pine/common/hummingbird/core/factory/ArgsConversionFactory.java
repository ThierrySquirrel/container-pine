...
public class ArgsConversionFactory {
    ...
    public static Object[] getArgs(SocketChannelFacade<PineRequestContext> ctx, PineRequestContext msg, Object... object) {
        List<Object> argsList = new ArrayList<>();
        argsList.add(ctx);
        argsList.add(msg);
        argsList.addAll(Arrays.stream(object).toList());
