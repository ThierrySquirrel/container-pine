 ...
 * @since JDK 25
 */
public class PineEncode implements HummingbirdEncoder<PineRequestContext> {

    @Override
    public void encoder(PineRequestContext pineRequestContext, ByteBufferFacade byteBufferFacade) {
        byteBufferFacade.putBytes(CoderConstant.PINE.getValue());
